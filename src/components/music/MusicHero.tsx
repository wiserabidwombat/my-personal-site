...
// to be attributed with the full logo (icon + wordmark): at least 70px wide
// (h-6 renders 88-99px), white on dark backgrounds and black on light ones,
// never inline with or inside text, with clear space of half the icon's
// height (12-14px) on every side, including from the busy synth grid below
// -- the logo's top and bottom margins exceed that, and nothing else sits on
// its line. Both colors are mounted and swapped by
