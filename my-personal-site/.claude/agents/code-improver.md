...
skills: [optimize, refactor, audit, debug, view_file, edit_file, grep_search]
model: sonnet
---
...
# Output Format
When improving a file, use precise file edit blocks. Briefly explain *why* the optimization was made (e.g., "Optimized with React.memo to prevent layout thrashing").
